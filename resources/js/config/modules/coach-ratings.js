...
export default {
  ...
  columns: [
    ...
    { 'label-id': 'rating', 'label-name': 'Average Rating', 'label-type': 'range-inputs', 'label-class': 'fs-6', 'label-placeholder': 'Rating range', 'label-width': '120px', 'min': 1, 'max': 5, 'step': 0.1 },
